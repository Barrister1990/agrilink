          ...
          <div className="mb-6">
            ...
            <div className="flex items-center">
              ...
              <input 
                ...
                className="h-10 w-16 border-gray-200 text-center text-gray-700 focus:ring-green-500 focus:border-green-500"
              />
              <button 
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    <tbody className="divide-y divide-gray-200">
                      <tr>
                        ...
                        <td className="py-3 text-sm text-gray-700">FreshMarket</td>
                      </tr>
                      <tr>
                        <td className="py-3 text-sm font-medium text-gray-500">Origin</td>
                        <td className="py-3 text-sm text-gray-700">Ghana</td>
                      </tr>
                      <tr>
                        <td className="py-3 text-sm font-medium text-gray-500">Weight</td>
                        <td className="py-3 text-sm text-gray-700">1kg</td>
                      </tr>
                      <tr>
                        <td className="py-3 text-sm font-medium text-gray-500">Shelf Life</td>
                        <td className="py-3 text-sm text-gray-700">7 days</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    <tbody className="divide-y divide-gray-200">
                      <tr>
                        ...
                        <td className="py-3 text-sm text-gray-700">Cool, dry place</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td className="py-3 text-sm text-gray-700">Eco-friendly</td>
                      </tr>
                      <tr>
          ...
          {activeTab === "reviews" && (
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                <button className="bg-green-600 text-white hover:bg-green-700 py-2 px-4 rounded-md text-sm font-medium transition">
                  Write a Review
                </button>
              </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
          {Array(5).fill().map((_, idx) => (
            <Link href={`/all-product/${idx + 200}`} key={idx} className="group">
